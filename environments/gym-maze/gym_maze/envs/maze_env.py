...
class Maze(gym.Env):
  ...
  def __init__(self, maze=np.array([]), rat=(0,0), target=None):
    ...
    self.target = target or (nrows-1, ncols-1)   # target cell where the "cheese" is
  ...
  def reset(self, rat=(0,0), target=None):
    self.rat = rat
  ...
  def step(self, action):
    ...
    return envstate, reward, status, dict()
